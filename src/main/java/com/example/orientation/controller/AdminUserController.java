...
import com.example.orientation.common.ResultByTeacherLogin;
...
public class AdminUserController {
     ...
     */
    @PostMapping("/login")
    public ResultByTeacherLogin<String> adminLogin(@RequestBody AdminUserDto adminUserDto, HttpServletRequest request) {
        ...
        return ResultByTeacherLogin.successByStatus(userByStatus, token, loginStatus,adminUserDto.getTeacherNumber());
    }
